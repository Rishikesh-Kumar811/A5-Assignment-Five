...
### 💻 About This Project
**A5 Assignment Five** is one of my web development assignments. It showcases my ability to translate design requirements into a pixel-perfect, responsive frontend layout using pure **HTML5** and **CSS3** (Flexbox/Grid).
